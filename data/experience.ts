...
export const experienceData: Experience[] = [
  {
    ...
    subLabel: "Official Title: Software Developer | Permanent Direct Employee",
    period: "February 18, 2023 – Present",
    location: "Mumbai, India (Remote)",
    scope: "Permanent direct employee leading mobile architecture, high-performance UI systems, and cross-platform release engineering.",
    type: "Full-time",
    isCurrent: true,
    responsibilities: [
      "Owned mobile architecture and production delivery of flagship consumer energy monitoring applications (Duracell Energy).",
